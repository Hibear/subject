...
class Yancode{
    ...
    */
    static function generate($len=4,$font_size=48,$name='captcha',$width='',$height=''){
        ...
        $chars='bcdefhkmnrstuvwxyABCDEFGHKMNPRSTUVWXY0123456789';
        $str='';
        for($i=0;$i<$len;$i++){
        ...
        $border_color=imagecolorallocate($image,255,255,255);//设置边框颜色
        ...
        imagettftext($image,$font_size,0,$font_size/2.5,$height/1.2,$text_color,'./static/font/FuzzyCootie.ttf',$str);//用规定字体向图像写入文本
