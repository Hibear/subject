...
|
*/
$config['encryption_key'] = 'bc696e8132dae6197530f1fa143cGyaJ';
...
$config['sess_cookie_name'] = 'php_session'; //session cookie 的名称
$config['sess_expiration'] = 3600; //你希望 session 持续的秒数 如果你希望 session 不过期（直到浏览器关闭），将其设置为 0 单位是秒
$config['sess_save_path'] = '/tmp/devweixin'; //指定存储位置，取决于使用的存储 session 的驱动
...
$config['cookie_domain']	= 'wesogou.com';
$config['cookie_path']		= '/';
