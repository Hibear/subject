                        ...
                        <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <input type="text" name="vote_obj" placeholder="竞猜对象" value="<?php echo $info['vote_obj']?>" class="col-xs-10 col-sm-5">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 竞猜标题： </label>
                                <div class="col-sm-9">
                                    <input type="text" name="title" placeholder="标题" value="<?php echo $info['title']?>" class="col-xs-10 col-sm-5">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 竞猜图集： </label>
                                <div class="col-sm-9">
