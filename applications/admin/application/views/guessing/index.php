                                ...
                                <div class="widget-main">
                                    <form class="form-horizontal" role="form">
                                        <div class="form-group">
                                            <div class="col-sm-4">
                                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 竞猜活动名称 </label>
                                                <div class="col-sm-9">
                                    ...
                                    <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                        ...
                                        <?php foreach ($list as $key => $value) : ?>
                                            <tr>
                                                ...
                                                <td><?php echo $domain['h5']['url']?>/guessing/index?active_id=<?php echo $value['id']?></td>
                                                <td>
