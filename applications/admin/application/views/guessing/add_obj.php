                        ...
                        <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <input type="text" name="vote_obj" placeholder="竞猜对象" class="col-xs-10 col-sm-5">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="video" placeholder="参赛视频url" class="col-xs-10 col-sm-5">
                                </div>
                            </div>
                            <div class="form-group">
