                        ...
                        <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <input type="text" name="title" placeholder="礼品名称" value="<?php if(isset($info['title'])){echo $info['title'];}?>" class="col-xs-10 col-sm-5">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 库存量： </label>
                                <div class="col-sm-9">
                                    <input type="number" name="num" placeholder="库存量" value="<?php if(isset($info['num'])){echo $info['num'];}?>" class="col-xs-10 col-sm-5">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 兑换积分： </label>
                                <div class="col-sm-9">
                                    <input type="number" name="score" placeholder="兑换积分" value="<?php if(isset($info['score'])){echo $info['score'];}?>" class="col-xs-10 col-sm-5">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <textarea class="form-control limited" name="desc" style="margin-top: 0px; margin-bottom: 0px; height: 171px;"><?php if(isset($info['desc'])){echo $info['desc'];}?></textarea>
                                </div>
                            </div>
...
<script type="text/javascript">
    ...
    $('.del-spa').click(function(){
        ...
        var d = dialog({
            ...
            okValue: '确定',
            ok: function () {
                window.location.href = '/gifts/del/' + _self.attr('data-id') + '/' + _self.attr('data-del');
            },
            cancelValue: '取消',
            cancel: function () {}
        });
