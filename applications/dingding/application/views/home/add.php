                    ...
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="name" placeholder="名物件称" class="col-xs-10 col-sm-5">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 编号： </label>
                                <div class="col-sm-9">
                                    <input type="text" name="number" placeholder="编号" class="col-xs-10 col-sm-5">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 数量： </label>
                                <div class="col-sm-9">
                                    <input type="text" name="num" placeholder="数量" class="col-xs-10 col-sm-5">
                                </div>
                            </div>
